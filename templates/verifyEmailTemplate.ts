const verifyEmail = function (otp: string) {
  const html = `
    ...
    <body
      ...
      <div style="display: none;">A request to create your dmt account was received.
Click this link to confirm your account and log in</div>
                      ...
                      <tr>
                        <td class="sm-px-24"
                          ...
                          <p style="margin: 0 0 24px;">
                            A request to create your DMT account was received.
Use this link to confirm your account and log in
                          </p>
                          <a href="${otp}" class="hover-underline"
                          style="--text-opacity: 1; color: #7367f0;  text-decoration: none;">${otp}</a>
                          ...
                          <p style="margin: 0 0 16px;">
                            ...
                            <a href="contact@dmt.com" class="hover-underline"
                              style="--text-opacity: 1; color: #7367f0;  text-decoration: none;">contact@dmt.com</a>.
                          </p>
                          <p style="margin: 0 0 16px;">Thanks, <br>DMT Support Team</p>
                        </td>
                      </tr>
                      <tr>
